...
- Required fields: date, event_name, attack_type, attacker_ips, victim_ip, victim_port, description
- Optional fields: tlp, workflow_state, attacker_ports, confidence_level
